        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CustomerTaxAdministration = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CustomerBankAccountNumber = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    DateTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    StringPrice = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_InvoiceMasters_Offices_OfficeId",
                        column: x => x.OfficeId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InvoiceMasters_OfficeId",
                table: "InvoiceMasters",
                column: "OfficeId");
